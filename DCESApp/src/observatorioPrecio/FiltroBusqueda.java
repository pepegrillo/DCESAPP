...
public class FiltroBusqueda extends Estilos implements FieldChangeListener {
	...
	public FiltroBusqueda(int IdCategoria, String IdProductoMain) {
		...
		try {
			...
			for (int i = 0; i < filtro.IdMunicipio.size(); i++){
				...
				contentListCategoria = new HorizontalField(600, 110, HorizontalField.FIELD_HCENTER);
				//contentListCategoria.setBackground((Background) vColores.elementAt(i));
				
				contentListCategoria.setBorder(BorderFactory.createBitmapBorder(new XYEdges(0,8,0,8), Bitmap.getBitmapResource("bgProduct.png")));
