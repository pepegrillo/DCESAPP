...
public class PerfilProducto extends Estilos {
	...
	public PerfilProducto(String producto, String marca, String presentacion, String precio, String preciopromo, String nombre, final String latitudSt, final String longitudSt, String fecha) {
		...
		try {
            ...
            btnAceptarRegUser.setChangeListener( new FieldChangeListener( ) {
    			public void fieldChanged( Field field, int context ) {
    				...
    				UiApplication.getUiApplication().pushScreen(new VerMapa(latitudSt,longitudSt));
    			}
            });
